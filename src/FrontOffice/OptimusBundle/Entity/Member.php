 ...
 */  
 protected $compte;
 /**    
 * @ORM\OneToMany(targetEntity="Reward", mappedBy="member", cascade={"persist","remove"})     
 * 
 */    protected $reward;  
 /**  
 *
 ...
 */    
 protected $particips;   public function __construct()    { 
 $this->confirmed=false; 
 $this->datesent = new \DateTime('now');
 //        if($this->confirmed==true)//        {//            $this->dateconfirm = new \DateTime('now');//        }//            
 }  
