            ...
            columns: {
                identifier: function() {
                    ...
                    $td.each(function() {
                        ...
                        var span = '<span class="tabledit-span tabledit-identifier" required>' + $(this).text() + '</span>';
                        var input = '<input class="tabledit-input tabledit-identifier" required type="hidden" name="' + settings.columns.identifier[1] + '" value="' + $(this).text() + '" disabled>';
